...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 12 okt 2016 om 13:25
...
INSERT INTO `users` (`users_id`, `users_name`) VALUES
(1, 'Maaike'),
(2, 'Gerrit');
...
--
ALTER TABLE `users_groups`
  ADD CONSTRAINT `users-groups-groups` FOREIGN KEY (`groups_id`) REFERENCES `groups` (`groups_id`);

--
-- Beperkingen voor tabel `users_messages`
--
ALTER TABLE `users_messages`
  ADD CONSTRAINT `users-messages-users` FOREIGN KEY (`users_id`) REFERENCES `users` (`users_id`);
