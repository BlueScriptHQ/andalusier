            ...
            <div id="login-box-content">
                <form class="login-form" action="" method="post">
                    <div class="login-form-align">
                        ...
                        <input type="text" name="username" autocorrect="off" autofocus="true" autocomplete="off"
                               autocapitalize="off" spellcheck="false" id="username" maxlength="32"
                               placeholder="uw gebruikersnaam">
                    </div>
                    <div class="login-form-align">
                        <label for="">Wachtwoord</label>
                        <input type="password" name="password" autocorrect="off" autocomplete="off" autocapitalize="off"
                               spellcheck="false" id="password" maxlength="48" placeholder="uw wachtwoord">
                    </div>
                    <div id="status">
